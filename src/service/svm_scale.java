...
public class svm_scale
{
	...
	private void output(int index, double value)
	{
		...
		if(value != 0)
		{
			...
			outputLine += index +":"+value+" ";
//			BufferedWriter bWriter = null;
//			try {
//				bWriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(Constant.afterScaledFile)));
//				bWriter.write(index + ":"+value+" ");
//				bWriter.flush();
...
//			}
	...
	public void run(String []argv) throws IOException
	{
		...
		while (readline(fp) != null && line.length() > 0)
		{
			System.out.println("line = "+line+",  svm_scale line 200");
			StringTokenizer st = new StringTokenizer(line," \t\n\r\f:");
			
			String r = st.nextToken();
			System.out.println(r+" line 204");
...
//		s.run(argv);
		argv = new String[]{"-r","E:\\MyWork\\jee-mars\\EEG_workspace\\EEG_DevelopeTool\\data\\train\\train\\Reduction2\\trainData\\synscale.dat"
				,"E:\\MyWork\\jee-mars\\EEG_workspace\\EEG_DevelopeTool\\data\\train\\train\\Reduction2\\preData\\陈罗克17_5_2_白天似睡非睡.dat"};
		s.run(argv);
	}
}
